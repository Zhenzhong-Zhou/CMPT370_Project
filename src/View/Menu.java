...
public class Menu extends JMenuBar{
    private final static ImageIcon imgBoard_Wooden = new ImageIcon("./res/background1.png"),
            imgBoard_Wooden1 = new ImageIcon("./res/background2.png"),
            imgBoard_Gary = new ImageIcon("./res/gary.jpg"),
            imgBoard_Firework = new ImageIcon("./res/spakler.jpg");
